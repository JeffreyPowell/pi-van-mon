...
echo "<span style='position: relative; top: 0px; left: 10px; border: 1px solid red; font-family:sans-serif; font-size:18px; color:white;'>$device_name</span>";
echo "<span style='position: relative; top: 10px; left: 30px; border: 1px solid red; font-family:sans-serif; font-size:12px; color:white;'>$last_value</span>";
echo "<span style='position: relative; top: 20px; left: 40px; border: 1px solid red; font-family:sans-serif; font-size:12px; color:white;'>$device_units</span>";
echo "</div>";
echo "</div></td>";
