...
echo "<p style='position: relative; top: 20px; border: 1px solid red; font-family:sans-serif; font-size:12px; text-align:center; color:white;'>$device_name</p>";
echo "<p style='position: relative; top: 40px; border: 1px solid red; font-family:sans-serif; font-size:09px; text-align:center; color:white;'>$last_value</p>";
echo "<p style='position: relative; top: 60px; border: 1px solid red; font-family:sans-serif; font-size:09px; text-align:center; color:white;'>$device_units</p>";
echo "</div>";
$device_id      = 15;
$device_type    = (string) $config['devices']['type'][$device_id];
$device_ref     = (string) $config['devices']['ref'][$device_id];
